...
public class MainPanel extends Activity implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener {
	...
	private ImageView callPrefs, msgPrefs;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        this.interstitialAds = new InterstitialAd(this,"8486bc77cfbb41cc");
        adr_cancel = new AdRequest();
        interstitialAds.loadAd(adr_cancel);




        try {
          adView = (AdView) this.findViewById(R.id.add);
		...
		msgPrefs = (ImageView) findViewById(R.id.MsgPref);
...
//		if (CallerFlashlight.LOG) Log.d(TAG, "showHowTo");
  ...
  /*
    ...
    public void showRating(){
        ...
        adb.setMessage(getString(R.string.rate_message));
        adb.setPositiveButton(getString(R.string.rate_button), new DialogInterface.OnClickListener() {
        ...
        adb.setNegativeButton(getString(R.string.remind_me_later), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                // cancel
                if (interstitialAds.isReady()) {
                    interstitialAds.show();
